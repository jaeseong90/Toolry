    ...
    <footer className="border-t border-line-dim mt-16">
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-sm font-medium text-muted mb-3">패밀리 사이트</h3>
            <ul className="space-y-1.5">
              <li>
                <a href="https://jaeseong90.github.io" target="_blank" rel="noopener noreferrer" className="text-sm text-faint hover:text-accent transition-colors">
                  블로그
                </a>
              </li>
              <li>
                <a href="https://jaeseong90.github.io/jaeseong90Folio/" target="_blank" rel="noopener noreferrer" className="text-sm text-faint hover:text-accent transition-colors">
                  포트폴리오
                </a>
              </li>
              <li>
                <a href="https://jaeseong90.github.io/homepage-game/" target="_blank" rel="noopener noreferrer" className="text-sm text-faint hover:text-accent transition-colors">
                  미니 게임
                </a>
              </li>
            </ul>
